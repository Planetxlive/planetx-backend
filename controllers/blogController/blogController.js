...
const createBlog = async (req, res) => {
   ...
   const { title, category, description, image, contactInfo } = req.body;


   if (!title || !category || !description || !contactInfo) {
   ...
   try {
    const blog = new Blog({userId, title, category, description, image, contactInfo });
...
module.exports = { createBlog, updateBlog, deleteBlog, getBlogById, getBlogs, getBlogdByUserId };
